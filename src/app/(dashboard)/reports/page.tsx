...
export default async function ReportsPage() {
  ...
  // Fetch submitted report entries with user and template info (including schema for inline preview)
  ...
  const feedEntries: ReportFeedEntry[] = (entries ?? []).map((e: Record<string, unknown>) => {
    ...
    const rawSchema = template?.schema as TemplateSchema | null | undefined;
    const validSchema =
      rawSchema &&

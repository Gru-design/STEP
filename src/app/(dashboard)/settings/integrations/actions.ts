...
export async function saveIntegration(data: SaveIntegrationInput) {
  try {
    ...
    console.error("[Integrations] saveIntegration unexpected error:", err);
...
export async function deleteIntegration(id: string) {
  try {
    ...
    console.error("[Integrations] deleteIntegration unexpected error:", err);
    return { success: false, error: "予期しないエラーが発生しました" };
  }
}
...
export async function toggleIntegrationStatus(id: string, active: boolean) {
  try {
    ...
    console.error("[Integrations] toggleIntegrationStatus unexpected error:", err);
    return { success: false, error: "予期しないエラーが発生しました" };
  }
}
...
export async function testSlackWebhook(webhookUrl: string) {
  try {
    ...
    console.error("[Integrations] testSlackWebhook unexpected error:", err);
    return { success: false, error: "予期しないエラーが発生しました" };
  }
}
...
export async function testChatworkConnection(apiToken: string, roomId: string) {
  try {
    ...
    console.error("[Integrations] testChatworkConnection unexpected error:", err);
    return { success: false, error: "予期しないエラーが発生しました" };
  }
}

  ...
  return (
    <section id="contact" className="py-16 sm:py-24 md:py-32 bg-muted/40 border-t border-border">
      <div className="max-w-[720px] mx-auto px-6 text-center">
        ...
        <p className="text-[14px] sm:text-[16px] text-muted-foreground leading-[1.8] mb-8 sm:mb-12">
          STEPは現在ベータ版として提供中です。
        ...
        <div className="bg-white rounded-xl border border-border p-6 sm:p-10 mb-8">
          <div className="space-y-6">
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
              <a
                href="mailto:sales@step-app.jp"
                className="inline-flex items-center justify-center px-8 sm:px-10 py-4 rounded-lg bg-foreground text-white text-[15px] font-medium hover:bg-foreground/85 transition-colors"
              >
                お問い合わせ
              </a>
              <Link
                href="/signup"
                className="inline-flex items-center justify-center px-8 sm:px-10 py-4 rounded-lg border border-border text-foreground text-[15px] font-medium hover:bg-muted/50 transition-colors"
              >
                無料で試す
              </Link>
            </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 text-left">
          {[
            ...
            <div key={item.title}>
              ...
              <p className="text-[12px] sm:text-[13px] text-muted-foreground leading-[1.6]">{item.desc}</p>
            </div>
          ))}
        </div>
      </div>

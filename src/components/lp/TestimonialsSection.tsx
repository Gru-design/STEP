    ...
    <section className="py-24 md:py-32 bg-white border-t border-border">
      <div className="max-w-[1200px] mx-auto px-6">
        <div className="max-w-2xl mb-20">
          ...
          <h2 className="font-serif text-[32px] md:text-[40px] font-semibold text-foreground leading-[1.2] tracking-tight">
            導入企業の声
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {TESTIMONIALS.map((t) => (
            <div key={t.role} className="flex flex-col">
              <blockquote className="text-[15px] text-foreground leading-[1.85] flex-1 mb-8">
                &ldquo;{t.quote}&rdquo;
              </blockquote>
